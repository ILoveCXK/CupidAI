...
let LOGIN_CONFIG = {
  "logo": "/__auth/app/app-WgFJWtGV/0a7b4ede7a4b45e2b615980c2040a6a6",
...
export async function getLoginConfig() {
  ...
  if (staticResourceDomain && loginConfigVersion && id) {
    const url = app.__internal__?.resolveStaticResourceUrl?.(`/__auth/app/app-WgFJWtGV/login.config.v1_6067365b5a76446e4022394d4918843d.json`)
    if (!LOGIN_CONFIG) {
